...
public class ProductProgressBar extends View {
     ...
     * 进度条背景颜色
     */
    private int bgColor =  getResources().getColor(R.color.progresslan_bg);
    /**
     * 进度条颜色
     */
    private int progressColor = getResources().getColor(R.color.progressyellow);
    /**
     * 进度条文字颜色
     */
    private int progressTextColor = getResources().getColor(R.color.progressyellow);
    ...
    private void initAnimation() {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                textString = formatNum((int) value) + "%";
