...
package com.citzx.cslibrary.clusterutil.clustering.view;
...
import com.citzx.cslibrary.clusterutil.MarkerManager;
import com.citzx.cslibrary.clusterutil.clustering.Cluster;
import com.citzx.cslibrary.clusterutil.clustering.ClusterItem;
import com.citzx.cslibrary.clusterutil.clustering.ClusterManager;
import com.citzx.cslibrary.clusterutil.projection.Point;
import com.citzx.cslibrary.clusterutil.projection.SphericalMercatorProjection;
import com.citzx.cslibrary.clusterutil.ui.IconGenerator;
import com.citzx.cslibrary.clusterutil.ui.SquareTextView;
...
import static com.citzx.cslibrary.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
//        }
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            mColoredCircleBackground.getPaint().setColor(Color.parseColor("#1BACEF"));
                ...
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        if (animateFrom != null) {
                            ...
                            markerOptions.extraInfo(item.getMBundle());
                        } else {
